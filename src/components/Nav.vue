    ...
    <div class="nav_container">
      ...
      <ul v-show="!mobile" class="nav_bar">
        ...
        <li class="links">
          ...
          <ul class="links_title">
            <li class="link_container">
              <router-link class="link" :to="{ name: 'SearchApi' }"
                >輸入搜尋</router-link
              >
            </li>
            <li class="link_container">
              <router-link class="link" :to="{ name: 'ClickApi' }"
                >點擊更動</router-link
              >
            </li>
          </ul>
        ...
        <li class="links">
          ...
          <ul class="links_title">
            <li class="link_container">
              <router-link class="link" :to="{ name: 'Group' }"
                >分組</router-link
              >
            </li>
            <li class="link_container">
              <router-link class="link" :to="{ name: 'Carousel' }"
                >輪播圖</router-link
              >
            </li>
            <li class="link_container">
